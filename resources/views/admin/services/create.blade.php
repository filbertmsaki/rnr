<x-admin-layout>
    @section('page-title', 'New Services')
    @push('styles')
        <!-- summernote -->
    ...
    <section class="content">
        <div class="card ">
            <div class="card-body">
                <form id="kt_add_services_form" action="{{ route('admin.services.store') }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea id="short_description" class="form-control" name="short_description"  maxlength="150" required>{{ old('short_description') }}</textarea>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <button id="kt_add_services_submit" type="submit" value=""
                                class="btn btn-success float-right">Create Services </button>
                        </div>
                    </div>
                </form>
            </div>
