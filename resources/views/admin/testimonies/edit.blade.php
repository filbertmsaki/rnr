<x-admin-layout>
    @section('page-title', 'Edit Testimony')
    @push('styles')
        <!-- summernote -->
    ...
    <section class="content">
        <div class="card ">
            <div class="card-body">
                <form id="kt_add_testimony_form" action="{{ route('admin.testimonies.update',$testimony->id) }}" method="POST"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                    value="{{ old('name',$testimony->name) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="position" id="position" class="form-control"
                                    value="{{ old('position',$testimony->position) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="company" id="company" class="form-control"
                                    value="{{ old('company',$testimony->company) }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" name="arrangement" id="arrangement"
                                    value="{{ old('arrangement',$testimony->arrangement) }}" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label for="description">Description</label>
                                <textarea name="description" id="description" value="{{ old('description') }}" class="form-control" required>{{ old('description',$testimony->description) }}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <button id="kt_add_testimony_submit" type="submit" value=""
                                class="btn btn-success float-right">Update Testimony </button>
                        </div>
                    </div>
                </form>
            </div>
